			...
			<center><nav aria-label="...">
			  <ul class="pagination pagination-sm">
			    <li class="page-item"  style = "display: <?php if($page==1){echo 'none';}else {echo 'inline';} ?>">
			     <a class="page-link" href='facility_booking.php?page=<?php echo base64_encode($page-1);?>' tabindex="-1">Previous</a>
			    </li>
			    				<?php 

         					for($i=1;$i<=$total_pages;$i++){
         					
         						echo "<li class='page-item'><a class='page-link' href='facility_booking.php?page=".base64_encode($i)."'>".$i."</a></li>";
			    ...
			    <li class="page-item" style = "display: <?php if($page<$total_pages){echo 'inline';}else {echo 'none';} ?>">
			      <a class="page-link" href='facility_booking.php?page=<?php echo base64_encode($page+1);?>'>Next</a>
			    </li>
			  </ul>
			</nav></center>
	<!-- bootstrap pagination -->
