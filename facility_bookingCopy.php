...
$limit = 5;
$rec=$obj->facelity();
$no_of_rec = mysql_num_rows($rec);
$total_pages = ceil($no_of_rec/$limit); 
if(!isset($_GET['page'])){
 		$page = 1;
 	}
 	else{
 	...
 	$this_current_startpg = ($page-1)*$limit;
 	$get_facelity=$obj->facelity_limit($this_current_startpg,$limit);
...
<!--<i class="fa fa-edit"></i> -->Edit</a>
			...
			<center><nav aria-label="...">
			  <ul class="pagination pagination-sm">
			    <li class="page-item"  style = "display: <?php if($page==1){echo 'none';}else {echo 'inline';} ?>">
			     <a class="page-link" href='facility_bookingCopy.php?page=<?php echo base64_encode($page-1);?>' tabindex="-1">Previous</a>
			    </li>
			    				<?php 

         					for($i=1;$i<=$total_pages;$i++){
         					
         						echo "<li class='page-item'><a class='page-link' href='facility_bookingCopy.php?page=".base64_encode($i)."'>".$i."</a></li>";
			    ...
			    <li class="page-item" style = "display: <?php if($page<$total_pages){echo 'inline';}else {echo 'none';} ?>">
			      <a class="page-link" href='facility_bookingCopy.php?page=<?php echo base64_encode($page+1);?>'>Next</a>
			    </li>
			  </ul>
			</nav></center>
	<!-- bootstrap pagination -->
